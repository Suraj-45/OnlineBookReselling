...
public class DATATABLE extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "BOOK_SR_NO", "BOOK_NAME", "PRICE", "DESCRIPTION", "AUTHOR", "CUSTOMER_ID", "BOOK_CLASS"
            }
        ) {
        ...
        jLabel1.setText("ONLINE BOOK RESLLING SYSTEM");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
         boolean flag;
            ...
            String query = "select * from BOOKS ";//Storing MySQL query in A string variable
            ...
            while (resultSet.next()) {
             ...
             //Retrieving details from the database and storing it in the String variables
                ...
                String B = resultSet.getString("BOOK_NAME");
                Integer p = resultSet.getInt("PRICE");
                 String d = resultSet.getString("DESCRIPTION");
                  String A = resultSet.getString("AUTHOR");
                   Integer C = resultSet.getInt("CUSTOMER_ID");
                    String b = resultSet.getString("BOOK_CLASS");
              
                    
                    model.addRow(new Object[]{bb, B, p , d , A , C , b });//Adding row in Table
